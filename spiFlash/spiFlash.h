...
#define spiFlash_clk_high() digitalWrite(C,4,HIGH)
#define spiFlash_clk_low() digitalWrite(C,4,LOW)
#define spiFlash_mosi_high() digitalWrite(C,3,HIGH)
#define spiFlash_mosi_low() digitalWrite(C,3,LOW)
#define spiFlash_miso_check() digitalRead(C,1)
/*-----------------------------------------------------------------------------
